...
namespace App.Tests
{
    public class PoeDotTrade
    {
        ...
        public void PoeDotTradeTest_with_Apostrophe_in_itemname()
        {
            ...
            //Arrange
            var input = "From xcredzz: Hi, | would like to buy your Lionís Roar Granite Flask listed for 1 chance in Standard (stash tab 8; position: left 2, top 12) ";

            //Act
            ItemBuyDTO output = (ItemBuyDTO)MessageBuilder.ReadMessage(input, false);

            //Assert
            Assert.Equal("Lionís Roar Granite Flask", output.itemname);
